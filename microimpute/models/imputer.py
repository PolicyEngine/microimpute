    ...
    def fit(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            weight_col: Optional name of the column or column array/series containing sampling weights. When provided, `X_train` will be passed to the underlying learner's own weighted-fit interface as sample weights.
