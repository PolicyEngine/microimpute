...
We measure the impact of each predictor by excluding it from the QRF model and observing the resulting increase in average quantile loss relative to the full model (baseline loss: 1,661,723). Table~\ref{tab:leave_one_out} reports the results.
